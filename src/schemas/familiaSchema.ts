...
export const createFamiliaSchema = z.object({
  nomeResponsavel: z
    .string({ message: "Campo 'nomeResponsavel' é obrigatório." })
    .min(3, "O nome do responsável deve ter no mínimo 3 caracteres."),
  endereco: z
    .string({ message: "Campo 'endereco' é obrigatório." }),
  latitude: z.preprocess(
    numericPreprocess,
    z
      .number({ message: "Latitude é obrigatória e deve ser numérica." })
  ...
  longitude: z.preprocess(
    numericPreprocess,
    z
      .number({ message: "Longitude é obrigatória e deve ser numérica." })
  ...
  qtdMembros: z.preprocess(
    numericPreprocess,
    z
      .number({ message: "Campo 'qtdMembros' é obrigatório." })
